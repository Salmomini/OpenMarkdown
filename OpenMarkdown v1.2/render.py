...
# Block renderer
# ---------------------------
def render_list_items(items: List[Dict[str, Any]]) -> str:
    rendered_items = []
    for it in items:
...
def render_blocks(nodes: List[Dict[str, Any]]) -> List[str]:
    ...
    for n in nodes:
        ...
        if t == "heading":
            ...
            body.append(render_list_items(n["items"]))
...
def render_html(ast: Dict[str, Any], css: Optional[str] = None) -> str:
    ...
    doc_title = "OpenMarkdown1.2 \u2013 By Salmomini"
...
<meta name="generator" content="OpenMarkdown1.2 \u2013 By Salmomini">
...
def export_pdf(html_content: str, out_path: str) -> None:
    ...
    def set_pdf_metadata(pdf_path: str) -> None:
        ...
        meta_title = "OpenMarkdown1.2 \u2013 By Salmomini"
